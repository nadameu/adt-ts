type Equals<a> = (_: a) => (_: a) => boolean;

/** `id 'op' x == x` */
export const leftIdentity = <a>(eq: Equals<a>) => <id>(op: (_: id) => (_: a) => a) => (id: id) => (
  x: a
): boolean => eq(op(id)(x))(x);

/** `x 'op' id == x` */
export const rightIdentity = <a>(eq: Equals<a>) => <id>(op: (_: a) => (_: id) => a) => (id: id) => (
  x: a
): boolean => eq(op(x)(id))(x);

/** `id 'op' x == x 'op' id == x` */
export const identity = <a>(eq: Equals<a>) => (op: (_: a) => (_: a) => a) => (id: a) => (
  x: a
): boolean => leftIdentity(eq)(op)(id)(x) && rightIdentity(eq)(op)(id)(x);

/** `a 'op' (b 'op' c) == (a 'op' b) 'op' c` */
export const associative = <a>(eq: Equals<a>) => (op: (_: a) => (_: a) => a) => (a: a) => (
  b: a
) => (c: a): boolean => eq(op(a)(op(b)(c)))(op(op(a)(b))(c));

/** `a 'op' b == b 'op' a` */
export const commutative = <a>(eq: Equals<a>) => (op: (_: a) => (_: a) => a) => (a: a) => (
  b: a
