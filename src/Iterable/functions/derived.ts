...
export const pipeK = d.pipeK({ bind } as BindOnly_1<TIterable>);
export const wrapBind = d.wrapBind({ bind } as BindOnly_1<TIterable>);
export const composeK = d.composeK({ bind } as BindOnly_1<TIterable>);
