...
export const append = list.append as Monoid_1<TNEList>['append'];
export const mempty = list.mempty as Monoid_1<TNEList>['mempty'];

export const alt = list.alt as Alternative_1<TNEList>['alt'];
export const empty = list.empty as Alternative_1<TNEList>['empty'];
...
export const foldMap1: Foldable1_1<TNEList>['foldMap1'] = <m>({ append }: Anon<Semigroup_0<m>>) => <
  a
>(
  f: (_: a) => m
) => (fa: NEList<a>): m => list.foldl<a, m>(ys => x => append(ys)(f(x)))(f(fa.head))(fa.tail);
