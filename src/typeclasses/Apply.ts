...
interface Helpers2<f extends Generic2> {
  ...
  lift2: <b, c, d>(
    f: (_: b) => (_: c) => d
  ) => <a>(fab: Type2<f, a, b>) => (fac: Type2<f, a, c>) => Type2<f, a, d>;
  lift3: <b, c, d, e>(
    f: (_: b) => (_: c) => (_: d) => e
  ) => <a>(fab: Type2<f, a, b>) => (fac: Type2<f, a, c>) => (fad: Type2<f, a, d>) => Type2<f, a, e>;
  lift4: <b, c, d, e, g>(
    f: (_: b) => (_: c) => (_: d) => (_: e) => g
  ) => <a>(
    fab: Type2<f, a, b>
  ) => (fac: Type2<f, a, c>) => (fad: Type2<f, a, d>) => (fae: Type2<f, a, e>) => Type2<f, a, g>;
  lift5: <b, c, d, e, g, h>(
    ...
    fac: Type2<f, a, c>
  ) => (fad: Type2<f, a, d>) => (fae: Type2<f, a, e>) => (faf: Type2<f, a, g>) => Type2<f, a, h>;
}
type Helper = {
