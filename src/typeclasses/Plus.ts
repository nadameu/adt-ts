...
import { Alt_1, Alt_2, Alt_A, Alt_O } from './Alt';
...
export interface EmptyOnly_A extends G.IdentifiedA {
  empty: <a = never>() => a[];
}
export interface Plus_A extends Alt_A, EmptyOnly_A {}
...
export const makePlusInstance: {
  ...
  ({ alt, empty, map }: G.Anon<Plus_A>): Plus_A;
} = identity;
